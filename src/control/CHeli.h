...
public:
    ...
    // sets the pitch, roll, yaw and vertical speed. The hover flag, if greater than 0, it will
    // force the parrot to do hover (remain fixed)
    void setAngles(float pitch, float roll, float yaw, float vertical, int hover = 0) ;
